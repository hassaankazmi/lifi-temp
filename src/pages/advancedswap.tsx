...
export const Advancedswap = () => {
    return (
        <>
            <div className='main min-h-screen'> text-lg text-[#9b9b9b] font-no rmal pl-[7px] pr-[9px] py-[2px] bg-[#000000] border border-transparent rounded-lg flex items-center gap-2
                <div className="App">
                                        ...
                                        <div className='relative you-pay bg-[#272727] rounded-2xl border-transparent p-4 hover:border-gray-700'> 
                                         ...
                                         <div className="">
                                          ...
                                          <div className='flex items-center justify-between gap-2'>
                                                       <div>
                                                       <button id="dropdownDefaultButton119" data-dropdown-toggle="dropdown119" className=" text-lg text-[#9b9b9b] font-no rmal pl-[7px] pr-[9px] py-[2px] bg-[#000000] border border-transparent rounded-lg flex items-center gap-2" type="button">
                                                   ...
                                                   <div>  <button id=""  className=" rounded-md border border-[#34373F] inline-flex items-center bg-[#000] px-1.5 pr-[10px] py-[3px] text-sm sm:text-lg font-semibold text-[#E7E8DE] uppercase  border-0  hover:bg-black" type="button">
                                ...
                                <p className='text-[12px] text-[#9b9b9b]'>Ether(~$2196.37)</p>
                                        ...
                                        <div className='you-pay bg-[#272727] rounded-2xl border-transparent p-4 hover:border-gray-700 mt-[3px]'>
                                            ...
                                            <div className="relative">
                                                <input type="text" name="text" id="email" autoComplete='off' className="mt-2 block px-0 text-[22px] leading-[22px] sm:text-[32px] bg-transparent w-full rounded-md border-0 py-0.5 text-[#E7E8DE] shadow-0 ring-1 ring-transparent ring-gray-300 text-[#9b9b9b] placeholder:text-[#E7E8DE] focus:transparent focus:ring-transparent  sm:leading-1" placeholder="0" />
                                                <div className='flex justify-between items-center mt-2'>
                                                <div className=''>
                                                        <button id="dropdownDefaultButton118" data-dropdown-toggle="dropdown118" className=" text-lg text-[#9b9b9b] font-no rmal pl-[7px] pr-[9px] py-[2px] bg-[#000000] border border-transparent rounded-lg flex items-center gap-2" type="button">
                                                            <img className="w-6 h-6 p-[4px]" src={ethsmall} alt="eth" />
                                                            <p className="text-[14px]">Ethereum</p>
                                                            <svg className="-mr-1 h-5 w-5 text-[#9b9b9b]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg>
                                                        </button>
                                                    ...
                                                    <button id="" className="rounded-md border border-transparent inline-flex items-center bg-[#000] px-[10px] pr-[10px] py-[4px] pb-[4px] text-sm sm:text-lg font-semibold captilize   hover:bg-black" type="button">
                                                       <p className="mr-2 xl:mr-1 text-[18px] text-gradient">Select Token</p><svg className="-mr-1 mt-1 h-[22px] w-[22px] text-[#c79eb9]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg>
                                                    </button>
                                      ...
                                      <span className='text-[11px] md:text-[14px] text-left'>1 WBTC = 18.8205 WETH <span className='text-[11px] md:text-[12px] text-[#9b9b9b]'>($42,137.49)</span></span>
                               <div className='flex items-center gap-2'> <div className='flex gap-2'><img className='h-[15px] brightness-50' src={fuel} /><p className='text-[11px] md:text-[12px] font-medium text-[#9b9b9b]'>$46.44</p></div>

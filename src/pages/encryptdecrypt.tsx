...
export const Encryptdecrypt = () => {
                    ...
                    <div className='flex md:flex-row flex-col gap-[10px] lg:gap-[28px] justify-center items-start'>
                        <div className='rounded-[10px] bg-[#2222268a] border border-[#34373F] p-[17px] w-[370px] w-full md:w-[500px]'>
                            ...
                            <div className='mt-[25px]'>
                                <p className='text-[16px]'>Solve Y</p>
                                <div className='flex justify-end gap-[12px] items-center'>
                                    <span className='text-[18px] text-[#40C5E8] font-[500]'>Y=</span>
                                    <textarea className='w-[75%] text-[13px] font-[400] bg-[#181819] border border-[#323232] h-[175px] rounded-[6px] p-[15px] placeholder:text-[#FFFFFFA3] focus:ring-0 focus:border-[#323232] dark:bg-transparent dark:border-[#323232]' placeholder='Type Y (Y=Information)'>
                                ...
                                <div className='mt-[11px]'>
                                    ...
                                    <button className='mt-[11px] uppercase rounded-full p-[11px] text-[13px] text-[#40C5E8] font-[600] border border-[#40C5E8] w-full'>UNSEAL</button>
                        ...
                        <div className='rounded-[10px] bg-[#2222268a] border border-[#34373F] p-[17px] w-full md:w-[500px]'>
                            ...
                            <div className='mt-[25px]'>
                                ...
                                <div className=' mt-[11px] md:mt-0 text-[12px] lg:text-[13px] font-[400] bg-[#212121] border border-[#323232] h-[200px] rounded-[6px] pt-[10px] p-[15px] placeholder:text-[#FFFFFFA3]'>
                                    ...
                                    <div className=' mt-[11px] md:mt-[10px] text-[12px] lg:text-[13px] font-[400] bg-[#212121] border border-[#323232] h-[200px] rounded-[6px] pt-[10px] p-[15px] placeholder:text-[#FFFFFFA3]'>
                                        <div className='flex flex-col justify-between text-[12px] lg:text-[13px] h-full'>
                                            <textarea placeholder='Type Y (Y=Information)' className='resize-none p-0 text-[13px] bg-transparent border-transparent placeholder:text-[#FFFFFFA3] focus:ring-0 focus:border-transparent dark:bg-transparent dark:border-transparent'></textarea>
                                     
                                            <div className='text-[#FF7676] '><p>Important:</p>
                                                <ul>
                                                    <li>
                                                        “Y” can be any text you choose
                                                    </li>
                                                    <li>Save “Y” safely as otherwise the seal can not be undone. If you lose “X” the pool can not be unsealed</li>
                                                </ul></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <label className="ms-1 font-medium text-[#5E5E5E] text-[13px]">Yes</label>
                                ...
                                <div className='mt-[11px]'>
                                    ...
                                    <button className='mt-[11px] uppercase rounded-full p-[11px] text-[13px] text-[#40C5E8] font-[600] border border-[#40C5E8] w-full'>SEAL</button>

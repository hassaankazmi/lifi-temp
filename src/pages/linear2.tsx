            ...
            <div className='main min-h-screen'>
               ...
               <div className='flex justify-center gap-3 '>
                                        <div className='flex items-center justify-center gap-[10px] ml-[25px]'>
                                            ...
                                            <span className='text-[30px] md:text-[40px] font-[500] text-[#8B6BE3] ml-[5px]'>linear1</span>
                    ...
                    <div className='flex md:flex-row flex-col items-start justify-between gap-[10px]'>
                        ...
                        <div className='w-full md:w-[50%] mt-[10px] bg-[#272727] rounded-[22px] p-[20px] lg:p-[30px]'>
                            ...
                            <div className='mt-[25px] p-[30px] rounded-[12px] bg-[#8B6BE3] min-h-[230px] lg:min-h-[310px]'>

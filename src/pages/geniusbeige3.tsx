...
import Headerbeige3 from '../components/headerbeige3';
export const Geniusbeige3 = () => {
    return (
        <>
            <div className='bg-[#d3d3d3] bg-gray new-h'>

                <div className="App">
                    <Headerbeige3 name="John" />
                </div>

                <div className='font-[inter] pt-[100px]  mx-auto px-2 sm:px-4 lg:px-4 w-12/12 py-0'>
                    <div className='flex justify-between gap-10 items-start mb-[100px] '>
                        <div className='side-app mt-[20px]'>
                            <div className='bg-[#212125] rounded-full px-[15px] py-[25px]'>
                                <ul>
                        ...
                        <div className='relative'>
                            <div className='w-[486px] pb-[60px] py-[33px] px-[40px] rounded-[30px] bg-[#212125] border border-[#34373F]'>
                                <div className='flex items-center justify-between mb-[40px]'>
                                    <p className='text-[#d3d3d3] text-[33px] font-semibold'>Operating Budget</p>
                                ...
                                <div className='input_mic'>
                                    <div className='relative'>
                                        ...
                                        <input
                                            ...
                                            className='pl-[45px] font-[Lausanne] z-20 relative input_token w-[405px] h-[46px] text-[#4bbcf9] bg-[#212125] text-[14px] font-medium placeholder:text-[#555555] px-[12px] py-[10px] border border-[#343434] rounded-full max-w-[460px]'
                                ...
                                <div className='mic_list pt-[30px]'>
                                    <div className='flex items-start justify-between pb-[15px]'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='text-[18px] text-[#d3d3d3] font-medium'>$13,650</p>
                                    ...
                                    <div className='flex items-start justify-between pb-[15px]'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='text-[18px] text-[#d3d3d3] font-medium'>$8,635</p>
                                    ...
                                    <div className='flex items-start justify-between pb-[15px]'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='text-[18px] text-[#d3d3d3] font-medium'>$4,242</p>
                                    ...
                                    <div className='flex items-start justify-between pb-[15px]'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='text-[18px] text-[#d3d3d3] font-medium'>$2,530</p>
                                    ...
                                    <div className='flex items-start justify-between pb-[15px]'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='text-[18px] text-[#d3d3d3] font-medium'>$3,304</p>
                            ...
                            <div className="flex justify-center gap-[14px] pb-[20px] absolute left-0 right-0 bottom-[-40px]">
                                        <nav className="flex space-x-4 bg-[#292929] rounded-full p-2" aria-label="Tabs">
                                            <a href="#" className=" w-full bg-[#3C3C3C] text-[#d3d3d3] rounded-full px-7 py-3 text-[14px] font-medium" aria-current="page">Date</a>
                        ...
                        <div className='mt-[20px] w-[296px] p-[15px] rounded-[10px] bg-[#212125] border border-[#34373F]'>
                            <p className='text-[28px] text-[#d3d3d3]'>drinks<span className='text-[#878787] pl-2'>meals</span></p>
                            <div className=" flex justify-start">
                                        <ul className='flex justify-end pt-[10px]'>
                                            <li><button className=' text-[15px] font-[Lausanne] py-[4px] px-[6px] font-semibold rounded-[6px] text-[#000] bg-[#d3d3d3] hover:bg-[#fff]'>soft</button></li>
                           ...
                           <img className='brightness-[0.5] h-[16px] w-[16px] absolute left-[13px] top-[16px] z-30' src={searchi} />
                            <input
                                ...
                                className='pl-[40px] font-[Lausanne] z-20 relative input_token w-full h-[50px] text-[#4bbcf9] bg-[#212125] text-sm font-medium placeholder:text-[#555555] px-[12px] py-[8px] border border-[#343434] rounded-lg max-w-[460px]'
                                placeholder='Search...'
                    ...
                    <div className='fixed bottom-0 left-0 right-0 footer-icons text-center mt-44 mb-2'>
                        <div className='mx-auto max-w-[150px] max-h-[82px] border border-[#404043] rounded-3xl bg-[#212125] p-[16px] px-[10px]  backdrop-sepia flex items-center justify-center'>
                            <div className='flex justify-between items-center gap-2'>
                                <div className='relative eth w-[60px] h-[60px] rounded-[22px] bg-[#424242] flex items-center justify-center border-[7px] border-[#212125] hover:border-black cursor-pointer'>
                                    <div className='tooltip opacity-0'>
                                        <div className='absolute top-[-50px] left-[0px] border border-[#343438] bg-[#38393a99] rounded-[7px] px-[8px] p-[4px] text-center text-[#d3d3d3]'><p>Compare</p>
                                        </div>
                                    </div>
                                    <img className="h-[28px] w-[auto] p-[4px]" src={f4} alt="eth" /></div>
                                <div className='relative eth w-[60px] h-[60px] rounded-[22px] bg-[#424242] flex items-center justify-center border-[7px] border-[#212125] hover:border-black cursor-pointer'>
                                    <div className='tooltip opacity-0'>
                                        <div className='absolute top-[-65px] left-[0px] border border-[#343438] bg-[#38393a99] rounded-[7px] px-[8px] p-[4px] text-center text-[#d3d3d3]'><p>Compare</p>
                                        </div>
                                    </div>
                                    <img className="h-[28px] w-[auto] p-[4px]" src={f4} alt="eth" /></div>
                            </div>

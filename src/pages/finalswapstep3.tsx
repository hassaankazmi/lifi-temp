            ...
            <div className='main'>
                ...
                <div className='pt-[150px] md:pt-[60px]'>
                    <div className='mx-auto px-[8px] sm:px-[16px] lg:px-[16px] w-11/12 text-center pb-[2px]'>
                        <div className='option box my-10 mt-[0px] flex gap-10 justify-center items-start'>
                            <div className='border border-[#34373F] bg-[#2222268a] max-w-5/12 w-5/12 rounded-2xl p-2 sm:p-5'>
                        ...
                        <div className='border border-[#34373F] bg-[#2222268a] max-w-5/12 w-5/12 rounded-2xl p-2 sm:p-5'>  
                          <div className=''>
                                <div className='choose head pb-5 flex items-center justify-between'>
                                    <div className='flex gap-4'><p className='text-left text-white text-md font-semibold'>You Get</p></div>
                                </div>
                                <div className='mb-[10px] text-left rounded-[19px] border border-[#34373F] p-4'>
                                    ...
                                    <div className=''>
                                       ...
                                       <div>  <img className='h-[50px] w-[50px]' src={fswap} /> </div>
                                        <div>
                                            <p className='text-[18px] text-semibold text-white'>
                                                9,1379
                                            </p>
                                            <div className='flex items-center gap-3'><p className='text-[#BDBEBE] text-[13px] font-medium'>$2,372.76</p> <span className='h-[7px] w-[7px] rounded-full bg-[#BDBEBE] block'></span><img src={fswap1} /><p className='text-[#BDBEBE] text-[13px] font-medium'>Connext</p></div>
                                        </div>
                                       </div>
                                        <div className='bg-[#212125] p-1 rounded-full text-center flex items-center justify-center'>
                                        <svg className=" h-5 w-5.5 text-[#fff]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg>
                                        </div>
                                       </div>

                                    </div>
                                    <div className='flex justify-between mt-[20px]'>
                                        <div className='flex gap-2'><img className='h-[18px]' src={fuel} /><p className='text-[12px] font-medium text-white'>$46.44</p></div>
                                        <div className='flex gap-2'><img className='h-[18px]' src={coin} /><p className='text-[12px] font-medium text-white'>$0.00</p></div>
                                        <div className='flex gap-2'><img className='h-[18px]' src={clock} /><p className='text-[12px] font-medium text-white'>7m</p></div>
                                        <div className='flex gap-2'><img className='h-[18px]' src={layers} /><p className='text-[12px] font-medium text-white'>1</p></div>
                                    </div>
                                </div>
                                ...
                                <div className='mb-[10px] text-left rounded-[19px] border border-[#34373F] p-4'>
                                    ...
                                    <div className=''>
                                       ...
                                       <div>
                                            <button className='bg-[#D4BAFF] font-medium flex items-center gap-1.5 rounded-lg px-2 py-1.5'><img className='h-[16px]' src={fswap1} /><p className='text-[#633AA1] text-[12px]'>Context</p></button>
                                        </div>
                                       </div>
                                     ...
                                     <div className=' flex items-center gap-2'>
                                        ...
                                        <div>
                                        <button className='bg-[#D4BAFF] font-medium flex items-center gap-1 rounded-lg px-3 py-1.5'><p className='text-[#633AA1] text-[16px]'>Hyphen via LI.FI</p></button>

                                        </div>
                                       </div>
                                       <div className='coin-left-b relative'>
                                        <ul className='pl-[50px] pt-[30px]'>
                                            <li className='flex items-center gap-4 mb-[18px]'>
                                            <img className='h-[22px] w-[22px]' src={fswapsmall} /><p className='text-[15px] text-white'>Swap on Ethereum via BSC</p>
                                            </li>
                                            <li className='flex items-center gap-4 mb-[18px]'>
                                            <img className='h-[22px] w-[22px]' src={fswap1} /><p className='text-[15px] text-white'>Bridge from etherium via BSC via connext</p>
                                            </li>
                                            <li className='flex items-center gap-4 mb-[18px]'>
                                            <img className='h-[22px] w-[22px]' src={fswapsmall} /><p className='text-[15px] text-white'>Swip or BSC 1inch</p>
                                            </li>
                                        </ul>
                                       </div>
                                     </div>
                                ...
                                <div className='mb-[10px] text-left rounded-[19px] border border-[#34373F] p-4'>
                                    ...
                                    <div className=''>
                                     ...
                                     <div className=' flex items-center gap-2'>
                                        ...
                                        <div>
                                        <button className='bg-[#D4BAFF] font-medium flex items-center gap-2 rounded-lg px-3 py-1.5'><p className='text-[#633AA1] text-[16px]'>Hyphen via LI.FI</p></button>

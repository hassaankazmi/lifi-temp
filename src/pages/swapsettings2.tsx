                    ...
                    <div className='mx-auto px-[20px] sm:px-[20px] lg:px-[30px] xl:w-10/12 text-center'>
                        <div className='option box my-10 mt-[0px]'>
                            <div className='flex md:flex-row flex-col items-start gap-4 justify-center'>
                                <div className='text-left font[inter] border border-[#34373F] bg-[#131313]  rounded-2xl md:w-8/12  xl:w-5/12 w-full p-2 px-[10px] pb-[20px] '>
                                ...
                                <div className='text-left font[inter] border border-[#34373F] bg-[#131313]  rounded-2xl md:w-8/12  xl:w-80 w-12/12 p-[16px] '>
                                    <div className=''>
                                        ...
                                        <div className='flex justify-between items-start gap-[20px] pb-[16px] border-b border-[#ffffff12]'>
                                            ...
                                            <label className="mt-[10px] relative flex items-center  justify-end cursor-pointer">
                                                <input type="checkbox" value="" className="sr-only peer" checked />
                                                <div className=" bg-[#9383ff] w-[63px] h-[34px] rounded-full peer peer-focus:ring-4 peer-focus:[#9383ff] dark:peer-focus:[#9383ff] dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-1 after:end-[28px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[24px] after:w-[24px] after:transition-all dark:border-gray-600 peer-checked:[#9383ff]"></div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className='mt-1' id="accordion-collapse" data-accordion="collapse">
                                        <h2 id="2">
                                            <button type="button" className=" bg-transparent flex items-center justify-between w-full py-[12px] px-[0px] font-medium rtl:text-right text-[#E7E8DE] border  border-transparent rounded-2xl focus:ring-0  dark:focus:ring-transparent dark:border-gray-700 dark:text-[#9b9b9b] hover:bg-transparent dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-2" aria-expanded="true" aria-controls="accordion-collapse-body-2">
                                                ...
                                                <div className='flex items-center gap-2'><span>Auto</span> <img src={ardown} data-accordion-icon className="rotate-180 w-3 h-3  shrink-0" aria-hidden="true" /> </div>
                                    ...
                                    <div className='mt-1' id="accordion-collapse" data-accordion="collapse">
                                        <h2 id="3">
                                            <button type="button" className=" bg-transparent flex items-center justify-between w-full py-[12px] px-[0px] font-medium rtl:text-right text-[#E7E8DE] border  border-transparent rounded-2xl focus:ring-0  dark:focus:ring-transparent dark:border-gray-700 dark:text-[#9b9b9b] hover:bg-transparent dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-3" aria-expanded="true" aria-controls="accordion-collapse-body-3">
                                                ...
                                                <div className='flex items-center gap-2'><span>10m</span> <img src={ardown} data-accordion-icon className="rotate-180 w-3 h-3  shrink-0" aria-hidden="true" /> </div>
                            ...
                            <div className='flex md:flex-row flex-col gap-4 justify-center'>
                                <div className='w-full lg:w-5/12 mt-[15px] py-[20px] px-[20px] rounded-2xl bg-[#131313] border border-[#34373F] '>
                                    <div className='flex items-center justify-between gap-2'>

                                        <p className='text-[#d3d3d3] text-[24px] font-semibold'>Enabled exchanges</p>
                                ...
                                <div className='w-full lg:w-5/12 mt-[15px] py-[20px] px-[20px] rounded-2xl bg-[#131313] border border-[#34373F]'>
                                    <div className='flex items-center justify-between gap-2 '>
                                        ...
                                        <p className='text-[#d3d3d3] text-[#d3d3d3] text-[24px] font-semibold'>Enabled bridges</p>
                                        <div className=''><img src={menub} /></div>
                                    </div>
                                    <div className='relative my-[20px]'>
                                        <img src={search} className='h-[16px] w-[16px] absolute left-[15px] top-[18px] z-30 brightness-50' />

...
import cgp from "../images/cgraph.svg";
        ...
        <>
            <div className='main min-h-screen'>
                ...
                <div className='max-w-[1280px] mx-auto pt-[100px] md:pt-[150px] px-[20px] pb-[100px] font-[Inter]'>
                    <div>
                        <h1 className='text-[#E7E8DE] text-[22px] md:text-[50px] md:leading-[56px]'>Ethereum / Dai</h1>
                        <p className='text-[#686868] text-[14px] md:text-[20px]  font-[500] py-[10px]'>Current market price </p>
                        
                    </div>
               <div>
               <div className='mt-[20px] flex lg:flex-row flex-col items-start justify-between gap-[10px]'>
                        <div className='w-full lg:w-[60%] bg-[#2222268a] border-[#34373F] border rounded-[22px] p-[15px] lg:p-[20px]'>
                            <div className='flex justify-start gap-1 items-center'>
                            <div className='flex items-center gap-[6px] '>
                                            <img src={eth} className='h-[30px] w-[30px] rounded-full' />
                                            <img src={dai2} className='h-[30px] w-[30px] rounded-full ml-[-10px]' />
                                            
                                        </div>
                                <p className='ml-[10px] text-[#E7E8DE] text-[24px]'>ETH / <span className='text-[16px] text-[#ffffff99]'>DAI</span></p>
                          
                            </div>
                            <div className='mt-[10px]'>     <p className='text-[24px] text-[#E7E8DE]'>$500,000,50</p>
                                <p className='text-[14px] font-[300]  text-[#ffffff99]'>12 28, 2023, 16:30</p></div>
                            
                            <div className='mt-[30px]'>
                                <ul className='flex items-center gap-1 flex-wrap'>
                                <li className='text-[12px] text-[#898989] px-[7px] md:px-[13px] py-[7px]'>
                                 1 Min
                                    </li>
                                    <li className='text-[12px] text-[#898989] px-[7px] md:px-[13px] py-[7px]'>
                                   5 Min
                                  ...
                                  1 Month
                                    ...
                                    <li className='text-[12px] text-[#000000] px-[13px] py-[7px] rounded-md bg-[#ffffff] '>
                               1 Year
                                    </li>
                                    <li className='text-[12px] text-[#898989] px-[7px] md:px-[13px] py-[7px]'>
                          All
                            ...
                            <div className='mt-[30px]'>
                            <img src={cgp} className='w-full md:h-[350px] cover' />
                            </div>
                            <div className='links mt-10'>
                                        <p className='text-[14px] pb-2 text-[#E7E8DE] font-light '>Links</p>
                                        <ul className='flex gap-2.5'>
                                            <li className='text-[#c59eb8] text-[13px] font-medium'><a href='#'>Etherscan ↗</a></li>
                                            <li className='text-[#c59eb8] text-[13px] font-medium'><a href='#'>More Analytics ↗</a></li>
                                         
                                        </ul>
                                        <div className='mt-5'>
                                        <div className='mt-1 mb-[10px]'>
                                                <p className='text-[#a1a1a6]'> <strong className='text-[14px] pb-2 text-[#E7E8DE] font-light '>Contract address:</strong></p>
                                                <button className='flex items-center gap-3 mt-[10px] text-[11px] md:text-[13px] font-[Inter] py-[0px]  rounded-full mb-[10px]'><span className='text-[#E7E8DE] '>0x949d48eca67b17269629c7194f4b727d4ef9e5d6</span><svg className='h-3 w-3 md:h-4 md:w-4' xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 488.3 488.3" ><g><path d="M314.25 85.4h-227c-21.3 0-38.6 17.3-38.6 38.6v325.7c0 21.3 17.3 38.6 38.6 38.6h227c21.3 0 38.6-17.3 38.6-38.6V124c-.1-21.3-17.4-38.6-38.6-38.6zm11.5 364.2c0 6.4-5.2 11.6-11.6 11.6h-227c-6.4 0-11.6-5.2-11.6-11.6V124c0-6.4 5.2-11.6 11.6-11.6h227c6.4 0 11.6 5.2 11.6 11.6v325.6z" fill="#919192" opacity="1" data-original="#000000" ></path><path d="M401.05 0h-227c-21.3 0-38.6 17.3-38.6 38.6 0 7.5 6 13.5 13.5 13.5s13.5-6 13.5-13.5c0-6.4 5.2-11.6 11.6-11.6h227c6.4 0 11.6 5.2 11.6 11.6v325.7c0 6.4-5.2 11.6-11.6 11.6-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5c21.3 0 38.6-17.3 38.6-38.6V38.6c0-21.3-17.3-38.6-38.6-38.6z" fill="#919192" opacity="1" data-original="#000000"></path></g></svg></button>
                                            </div>
                                    </div>
                                    </div>
                        </div>
                    
                        <div className='w-full lg:w-[40%] option box mt-8 pb-[100px] mt-[0px] '>
                        <div className='border border-[#34373F] bg-[#2222268a]  rounded-2xl p-[10px] sm:p-5'>
                                <div className='choose head px-[12px] md:pt-0 pt-[3px] pb-[15px] md:pb-5 flex items-center justify-between'>
                                    ...
                                    <svg className="h-6 w-6 text-[#9ca3af]"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <line x1="12" y1="5" x2="12" y2="19" />  <line x1="5" y1="12" x2="19" y2="12" /></svg>
                                    ...
                                    <div className='bg-[#000] p-1 rounded-2xl'>
                                        <div className='relative you-pay bg-[#272727] rounded-2xl border-transparent p-4 hover:border-gray-700'> 
                                         ...
                                         <div className="">
                                          ...
                                          <div>
                                          <button id=""  className="rounded-md border border-[#34373F] inline-flex items-center bg-[#000] px-1.5 pr-[10px] py-[3px] text-sm sm:text-lg font-semibold text-[#E7E8DE] uppercase  border-0  hover:bg-black" type="button">
                                        ...
                                        <div className='you-pay bg-[#272727] rounded-2xl border-transparent p-4 hover:border-gray-700 mt-[3px]'>
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className='flex justify-end items-center'>
                                                    ...
                                                    <button id="" className="rounded-md border border-transparent inline-flex items-center bg-[#000] px-[10px] pr-[10px] py-[4px] pb-[4px] text-sm sm:text-lg font-semibold text-[#E7E8DE] captilize   hover:bg-black" type="button">
                               ...
                               <div className='flex items-center gap-2'> <div className='flex gap-2'><img className='h-[15px] brightness-50' src={fuel} /><p className='text-[12px] font-medium text-[#9b9b9b]'>$46.44</p></div>
                                            ...
                                            <div id="accordion-collapse-body-1" className="hidden mt-[-25px]" aria-labelledby="accordion-collapse-heading-1">
                                                <div className="p-[16px] pb-[5px] pt-[25px] border border-t-0  border-[#34373F] rounded-b-2xl dark:border-gray-700 bg-[#1d1d20]">
                                                    ...
                                                    <div className='py-2 flex justify-between border-t border-t-[#34373F]'>
                                                        ...
                                                        <div className="border border-[#ffffff12] w-[30%] rounded-[10px] pr-[13px] pl-[5px] flex justify-between items-center"><span className='block bg-[#ffffff12] text-[#9b9b9b] text-[12px] px-[7px] pt-[2px] pb-[3px] rounded-md'>auto</span><input type="text" min="1" max="100" className="text-right w-full py-1 px-2 placeholder:text-[#ABACAC] text-[#E7E8DE] font-normal text-[14px] bg-transparent border-none focus:border-transparent focus:ring-0 focus:outline-none" placeholder="0.5" /><p className="text-[13px] text-[#E7E8DE] font-semibold">%</p></div>

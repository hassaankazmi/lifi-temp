    ...
    return (
        <>
            <div className='main h-screen'>
                ...
                {/* <p className='relative leading-none top-[-35px] font-grok pb-[20px] pr-[30px] pl-[20px] mb-[-1px] flex items-center text-[52px] sm:text-[72px] md:text-[82px] lg:text-[120px] font-bold text-gradient'>Ob<span className='font-sans'>j</span>ects</p> */}

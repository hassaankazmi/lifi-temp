        ...
        <>
            <div className='main h-screen'>
                ...
                <div className='h-full mx-auto px-2 sm:px-4 lg:px-4 w-11/12 py-0 text-center w-full flex justify-center items-center flex-col'>
                    <div className='flex flex-col justify-center items-center h-full max-w-[600px] mx-auto text-center'>
                        <p className='  font-grok leading-none pr-[30px] pl-[20px] mb-[-1px] text-[72px] md:text-[120px] font-bold text-gradient'>404</p>

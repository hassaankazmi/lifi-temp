        ...
        <>
            <div className='main'>
               ...
               <div className='mx-auto px-[0px] sm:px-[16px] lg:px-[16px] w-11/12 text-center pb-[2px]'>
                    <div className='bg-[#292929] text-white text-[12px] sm:text-[16px] px-4 py-2 pb-2.5 rounded-full inline text-center font-normal pt-[9px]'>Oh hey 👋🏽 <span className='font-[Lausanne] text-[11px] md:text-[15px] font-bold inline-block bg-gradient-to-r bg-gradient-to-r from-[#03f6f4] to-[#9383ff] inline-block text-transparent bg-clip-text '>0x949d48eca67b17269629c7194f4b727d4ef9e5d6</span></div>
                        ...
                        <div className='border border-[#34373F] bg-[#18191B]  rounded-2xl  lg:w-6/12 sm:w-10/12 w-12/12 mx-auto p-3 sm:p-6'>
                            ...
                            <div className='relative option-content rounded-2xl w-full p-0.5 inline-block bg-gradient-to-r bg-gradient-to-r from-[#03f6f4] to-[#9383ff]'>
                                <div className='bg-black p-4 rounded-2xl'>
                                    <div className='you-pay bg-[#18191B] rounded-2xl border-transparent p-5 hover:border-gray-700'>
                                        <label className="block text-left text-sm font-medium leading-6 text-[#9b9b9b]">You Pay</label>
                                        <div className="relative">
                                            <input autoComplete='off' type="text" name="text" id="email" className="block px-0 text-lg sm:text-4xl bg-transparent w-full rounded-md border-0 py-0.5 text-white shadow-sm ring-1 ring-transparent ring-gray-300 text-[#9b9b9b] placeholder:text-[#9b9b9b] focus:transparent focus:ring-transparent  sm:leading-1" placeholder="0" />
                                    ...
                                    <div className='p-2 bg-[#18191B] border-black border-4 rounded-xl absolute left-[46%] top-[34%]'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><polyline points="19 12 12 19 5 12"></polyline></svg></div>
                                    <div className='mt-1 you-pay bg-[#18191B] rounded-2xl border-transparent p-5 hover:border-gray-700'>

...
const HeaderNew: React.FC<MyComponentProps> = ({ name }) => {
                ...
                <div className="relative flex pt-[15px] items-center justify-between">
                    <div className='flex items-center'>
                        ...
                        <div className="hidden lg:ml-[12px] sm:block menu-hide">
                            <div className="flex items-center">
                                <div>
                                    <a href='/analyse' className='lg:text-[16px] text-[13px] text-[#9b9b9b] font-medium py-[8px] px-[10px] lg:px-[14px] hover:bg-[#222226fa] border border-transparent hover:border-[#34373F] rounded-xl cursor-pointer'>Analyse</a>
                                    ...
                                    <button id="dropdownDefaultButtonT" data-dropdown-toggle="dropdownT" className="lg:text-[16px] text-[13px] flex justify-between  text-[#9b9b9b] leading-[20px] bg-transparent  focus:none focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-md px-[10px] lg:px-[14px] py-[8px] text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:bg-[#222226fa] border border-transparent hover:border-[#34373F]" type="button">Treasures
                                        <svg className="w-2.5 h-2.5 ms-2 lg:ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                        </svg>
                                    </button>
                    ...
                    <div className='flex items-center  gap-[5px] lg:gap-[10px]'>
                        ...
                        <div id="mobile-menu" className={isMenuOpen ? 'pl-[16px] Z-[999] md:hidden mr-[20px] pt-[15px] block space-y-1 px-4 pb-10 pt-2 fixed top-0 left-0 z-30 w-full h-full bg-[#181819] z-40' : 'md:hidden mr-[0px] mt-[0px]'}>
                            ...
                            {isMenuOpen && (
                                <div className='toggle-menus'>
                                    ...
                                    <ul className='text-left text-[#fffff5db] font-medium items-center gap-[1px] text-[17px] mr-[12px]'>
                                        <li className='py-2 '>
                                            <a href='/analyse' className='text-[#9b9b9b] font-medium py-[8px] px-[10px] lg:px-[14px] hover:bg-[#2222268a] rounded-xl cursor-pointer'>Analyse</a>
                                        ...
                                        <li className='py-2 '>
                                            <a href='/buy' className='text-[#9b9b9b] font-medium py-[8px] px-[10px] lg:px-[14px] hover:bg-[#2222268a] rounded-xl cursor-pointer'>Buy Crypto</a>

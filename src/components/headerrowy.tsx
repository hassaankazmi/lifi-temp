...
import logo1 from "../images/newlogo-removebg-preview.png";
...
const Headerrowy: React.FC<MyComponentProps> = ({ name }) => {
    ...
    return (
        <nav className="absolute w-full">
            <div className="mx-auto px-2 md:px-0 w-11/12 py-0 md:max-w-[1250px] 2xl:max-w-[1228px]">
                <div className="relative flex mt-[15px] items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-self-start sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <p className='font-[Lausanne] pr-2 mb-[-1px] flex items-center text-[23.3px] font-bold inline-block bg-gradient-to-r bg-gradient-to-r from-[#03f6f4] to-[#9383ff] inline-block text-transparent bg-clip-text'>Objects</p>
                            <span className='font-[Lausanne] text-[15px] text-[#8b8c8e] font-medium pl-1.5'>by The Lattice</span>
                            {/* <img className="h-6 xl:h-8 w-auto" src={logo1} alt="Your Company" /> */}
                        </div>
            ...
            <div id="mobile-menu" className={isMenuOpen ? 'block space-y-1 px-4 pb-10 pt-2 absolute w-full h-full bg-white z-40' : 'hidden'}>

...
const Footerlinksfixed: React.FC<MyComponentProps> = ({ name }) => {
    return (
        <>            
        <div className='fixed bottom-0 left-0 right-0 footer-icons text-center mt-[50px] mb-2'>
                        <div className='mx-auto max-w-max md:max-w-[304px] max-h-[82px] border border-[#404043] rounded-2xl md:rounded-3xl bg-[#2222268a] p-[5px] md:p-[16px] md:px-[10px]  backdrop-blur-[2px] flex items-center justify-center'>
                            <div className='flex justify-between items-center gap-[0px] md:gap-2'>
...
export default Footerlinksfixed;
